...
/* 
  ...
  return (
    <>
    <p className={`p-20 text-4xl text-gray-500 dark:text-gray-400 ${state.langMode ? "shown" : "hidden"}`}>關於我們</p>
    <p className={`p-20 text-4xl text-gray-500 dark:text-gray-400 ${state.langMode ? "hidden" : "shown"}`}>ABOUT US</p>

    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 pb-20">
      <img src={welcome} alt="welcomeimg" className="h-auto mx-auto mb-3" />
      <div className="mb-3 px-10 md:pr-20 md:pl-10 text-gray-500 dark:text-gray-400">
    ...
    <p className={`text-center p-20 text-4xl text-gray-500 dark:text-gray-400 ${state.langMode ? "shown" : "hidden"} `}>成員介紹</p>
